...
public class JwtService {
    ...
    @Value("${jwt.secret:ATBSecretKeyForCreditIntelligence2026WithEnoughLengthForHS512Algorithm}")
    ...
    // ===== Méthodes avec UserDetails (Pour compatibilité) =====
