...
public class FinancialAnalysisServiceImpl implements IFinancialAnalysisService {
    ...
    public FinancialAnalysisResponseDTO calculateAndSaveAnalysis(FinancialAnalysisRequestDTO request) {
        ...
        // Créer l'entité d'analyse
        FinancialAnalysis analysis = FinancialAnalysis.builder()
                .creditRequest(creditRequest)
                .client(client)
                .analyst(analyst)
                .monthlyNetIncome(request.getMonthlyNetIncome())
                .otherMonthlyIncome(request.getOtherMonthlyIncome())
                .totalMonthlyIncome(totalMonthlyIncome)
                .annualIncome(totalMonthlyIncome.multiply(BigDecimal.valueOf(12)))
                .monthlyCharges(request.getMonthlyCharges())
                .existingCreditPayments(request.getExistingCreditPayments())
