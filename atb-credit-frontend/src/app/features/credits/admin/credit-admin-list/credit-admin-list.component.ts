// features/credits/admin/credit-admin-list/credit-admin-list.component.ts
...
@Component({
  selector: 'app-credit-admin-list',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
  ...
  templateUrl: './credit-admin-list.component.html',
  styleUrls: ['./credit-admin-list.component.css']
})
export class CreditAdminListComponent implements OnInit {
  ...
  viewRequest(id: string): void {
    this.router.navigate(['/admin/credit-requests', id]);
  }

  editRequest(id: string): void {
    this.router.navigate(['/admin/credit-requests', id, 'edit']);
  }
  ...
  // ✅ CORRECTION : Créer une nouvelle demande (admin)
  createNewRequest(): void {
    this.router.navigate(['/admin/credit-requests/new']);
  }
